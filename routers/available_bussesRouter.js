...
router.post("/create_buses",availabe_buses.create_available_busses)
...
router.get("/one_bus",availabe_buses.find_single_bus)
router.delete("/delete_bus/:id",admin_auth,availabe_buses.delete_bus)
router.post("/available_buses",availabe_buses.find_by_initials)
